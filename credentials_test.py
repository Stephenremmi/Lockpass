...
class  TestCredentials(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.new_credentials=Credentials("instagram","s.remmi","123password")
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_credentials.app_username,"s.remmi")
    ...
    def test_save_multiple_credentials(self):
        ...
        """
        self.new_credentials.save_credentials()
        test_credential=Credentials("facebook","s.remmi","321password")
    ...
    #     test_credential=Credentials("facebook","s.remmi","321password")
    #     test_credential.save_credentials()
    #     # test_credential2=Credentials("facebook","stephen.remmi","322password")
    #     # test_credential2.save_credentials()

    #     found_account=Credentials.find_account("facebook","s.remmi")
    ...
    def test_credentials_exist(self):
        ...
        credentials_exist=Credentials.credential_exist("s.remmi")
    ...
    def test_generate_password(self):
        ...
        test_credential = Credentials("facebook","s.remmi",generated_password)
        test_credential.save_credentials()
